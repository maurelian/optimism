...
func TestSystemE2E(t *testing.T) {
	...
	tx, err := depositContract.DepositTransaction(opts, fromAddr, common.Big0, 5_000_000, false, nil)
...
func TestMintOnRevertedDeposit(t *testing.T) {
	...
	tx, err := depositContract.DepositTransaction(opts, toAddr, value, 5_000_000, false, nil)
	require.Nil(t, err, "with deposit tx")
